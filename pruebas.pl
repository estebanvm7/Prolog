...
oracion2 --> articulo(Ga, Ma, Ta), sustantivo(Gs, Ms, Ts), verbo(Mv,Tv), {Ga = Gs}, {N is Ma + Ms + Mv}, {N >= 5},{9 >= N }, {Ta = Ts}, {Ts = Tv}.
oracion3 --> articulo(Ga, Ma, Ta), sustantivo(Gs, Ms, Ts), verbo(Mv,Tv), {Ga = Gs}, {N is Ma + Ms + Mv}, {N >= 3},{7 >= N }, {Ta = Ts}, {Ts = Tv}.
haiku --> oracion, oracion2, oracion3.
